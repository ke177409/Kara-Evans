...
Customer data was analyzed to increase outreach and yield higher profits for an online grocery service. This project was a part of CareerFoundry’s Data Immersion curriculum and was evaluated by my tutor and mentor. 

The histogram at the top left shows the total number of orders for each day of the week. Saturday (day 0) and Sunday (day 1) are the busiest days, while Tuesday (day 3) and Wednesday (day 4) are the slowest.
